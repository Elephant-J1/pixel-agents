...
export function OfficeCanvas({ officeState, onClick, isEditMode, editorState, onEditorTileAction, onEditorEraseAction, onEditorSelectionChange, onDeleteSelected, onRotateSelected, onDragMove, editorTick: _editorTick, zoom, onZoomChange, panRef, agentStatuses }: OfficeCanvasProps) {
  ...
  }, [officeState, resizeCanvas, isEditMode, editorState, _editorTick, zoom, panRef, agentStatuses])
